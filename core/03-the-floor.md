...
establishes: [acceptance-predicate|acceptance predicate, closure|closes|closed|closing, floor|intrinsic floor, path-degeneracy|path degeneracy]
status: settled
-->
...
<!-- /ddd:embed -->
Formal decidability is the wrong instrument in both directions: any bounded finite domain is decidable by exhaustive lookup — making
