"""
DERIVING p_err FROM RATE-DISTORTION — closing the last real hole in core/11.
...
In core/11 I ASSUMED a logistic. That was a modelling choice, not a derivation.
...
print("Re-run core/11's soft results with the DERIVED p_err instead of the logistic.\n")
T=40
