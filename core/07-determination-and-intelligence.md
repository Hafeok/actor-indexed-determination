...
<!-- ddd:embed id=term:determination-intelligence-separation -->
...
The framework's contribution to this debate is **not a ruling.** It is the demonstration that **there
is no ruling available** — and, more usefully, **the map of where a ruling could ever come from.**
