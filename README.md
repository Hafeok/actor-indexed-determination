...
What ground does the determination depend on?
Can the result be checked?
From where is the determination supplied?
Who carries the consequence if it is wrong?
...
See `core/00-primitives.md` and `core/14-indexed-determination.md`.
---
The four stores
...
See `core/01-the-principle.md` and `core/02-completeness.md`.
---
...
See `core/03-the-floor.md`, `core/04-actors.md`, and `core/10-cost.md`.
---
...
See `core/04-actors.md` and `core/14-indexed-determination.md`.
---
...
See `core/11-the-floor-mechanism.md`.
---
...
See `core/07-determination-and-intelligence.md`.
---
...
See `core/12-the-licensing-instance.md`.
---
...
Ground and judgment dependence  
...
See `core/14-indexed-determination.md`.
---
...
Settled core
#	Document	Role
00	`primitives`	decisions, ground, determination, actor, arrangement, admission tests
01	`the principle`	determination demand and the four stores
02	`completeness`	why the store partition is exhaustive by construction
03	`the floor`	irreducibility lives in predicate closure
04	`actors`	pinning resolution, selection and training
05	`accountability`	executor vs accountable principal
06	`composition`	seam demand, orchestrators, mechanisms, compound
07	`determination and intelligence`	why determination does not imply intelligence
08	`projections`	funnel and maturation
09	`the measure`	verdict entropy and the chain-rule identification
10	`cost`	standing vs occasioned supply and actor routing
11	`the floor mechanism`	capacity, overflow and escape
12	`the licensing instance`	ensemble actors and the immune-system instance
Draft extensions
#	Document	Role
13	`delivery`	whether authored governance actually reaches the act
14	`indexed determination`	the full index, commitment levels, residual discretion, hypothesis set
