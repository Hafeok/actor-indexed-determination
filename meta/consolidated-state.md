...
**Scope.** This is the **principle repository's** consolidated state — authoritative for the shared,
actor-general claims. The software projection keeps its own consolidated state for projection-local
claims (LinkedIn/marketing, product, organisation design) and resolves shared claims upstream to here.
